...
public class MapTest extends TestParent{
	...
	public void mapTest(){
		...
		try {
			...
			TestHelpClass.sendRequest(TestHelpClass.makeJSONGet(TestHelpClass.getPathByAddingContent("map/allmaps")), TestHelpClass.createMethod(method, this));
			TestHelpClass.sendRequest(TestHelpClass.makeJSONDelete(TestHelpClass.getPathByAddingContent("map?id="+id2)), null);
	...
	public void mapsTest(String id){
		...
		TestHelpClass.sendRequest(TestHelpClass.makeJSONGet(TestHelpClass.getPathByAddingContent("map/maps?id=["+id+"]")), TestHelpClass.createMethod(method, this));
	}
	...
	public void createTest(String id){
		...
		TestHelpClass.sendRequest(TestHelpClass.makeJSONPut(mapUpdate.toString(), TestHelpClass.getPathByAddingContent("map?id="+id)), null);
	}
